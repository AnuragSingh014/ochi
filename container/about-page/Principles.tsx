					...
					<div className="w-[50%] sm:w-full xm:w-full flex flex-col gap-[20px]">
						...
						BABA MITRA, FOUNDER
							...
							Influidity is quiet a tongue twister name but it not simply a name, it’s a combination of two words infinity and fluidity.
							 Hence Infinite Solutions and Fluid Operations.Nevertheless, Influidity is formed with only one purpose that is to deliver growth and revenue to its clients through its multifaceted services.​
							 Influidity believes that growth should be the only constant in business. In the last financial year, Influidity has grown 350% even in the time of pandemic.​
